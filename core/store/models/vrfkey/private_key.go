...
// k.MarshaledProof(preSeed, blockHash, blockNum) is a VRF proof of randomness
// using k and seed, in the form required by VRFCoordinator.sol's
// fulfillRandomnessRequest
func (k *PrivateKey) MarshaledProof(preSeed *vrf.Seed, blockHash common.Hash,
	blockNum uint64) (*vrf.MarshaledOnChainResponse, error) {
